                ...
                <div className="bg-white rounded-lg shadow p-6">
                    ...
                    <form action="" onSubmit={handleSaveProfile} className="space-y-4">
                            ...
                            <label htmlFor="cover_photo" className='block text-sm font-medium text-gray-700 mb-1'>
                                ...
                                <input hidden type="file" accept='image/*' id='cover_photo'
                                    ...
                                    <div className='group/cover relative'>
                                        ...
                                        <div className="absolute hidden group-hover/hover:flex 
                                        top-0 left-0 right-0 bottom-0 bg-black'/20 rounded-lg items-center
                                        justify-center">
                                            <Pencil className='w-5 h-5 text-white' />
                                        </div>
                                    </div>
                        ...
                        <div>
                            ...
                            <input type="text" className='w-full p-3 border border-gray-200 rounded-lg'
                            placeholder='Please enter a Your Location'
                        ...
                        <div className="flex justify-end space-x-3 pt-6">
                            ...
                            <button type='submit' className='px-4 py-2 border bg-gradient-to-r from-indigo-500
