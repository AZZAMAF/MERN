    ...
    <div className='flex gap-4 pb-5 '>
        ...
        {/* Story Cards */}
        {
            stories.map((story,index)=>(
                <div onClick={()=> setViewStory(story)}key={index} className={`relative rounded-lg shadow min-w-30 max-h-40 cursor-pointer 
                            ...
                            <div className='absolute inset-0 z-1 rounded-lg bg-black overflow-hidden'>
                                {
                                    ...
                                    object-cover hover:scale-110 transition duration-500 opacity-70 hover:opacity-0' />
                                    :
