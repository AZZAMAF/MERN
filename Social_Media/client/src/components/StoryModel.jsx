...
const StoryModel = ({setShowModal, fecthStories}) => {
  const bgColors = ["#4f46e5","#7c3aed","#db2777","#e11248","#ca8a04","#0d9488"]
  ...
  return (
    <div className='fixed inset-0 z-110 mih-h-screen bg-black/80 backdrop-blur-2xl
    text-white flex items-center justify-center p-4'>
      <div className='w-full max-w-md'>
        ...
        <div className="flex gap-2 mt-4">
          ...
          p-2 rounded cursor-pointer ${mode === 'media' ? "bg-white text-black"
            : "bg-zinc-800"}`}>
