  ...
  return (
    ...
    shadow border border-gray-200 rounded-md'>
        ...
        <div className="flex mt-4 gap-2">
            {/* Follow Button */}
            <button onClick={handleFollow} disabled={currentUser?.following.includes(user._id)} className='w-full py-2 rounded-md flex justify-center items-center gap-2 
            ...
            {/* Connection Request */}
            <button className='flex items-center justify-center w-16 border text-slate-500 
