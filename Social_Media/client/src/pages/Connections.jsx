...
import {
    ...
    dummyPendingConnectionsData as pendingConections
} from '../assets/assets'
const Connections = () => {
    ...
    const dataArray = [
        ...
        {label: 'Pending', value: pendingConections, icon: UserRoundPen},
            ...
            rounded-md p-1 bg-white shadow-sm">
                {
                    dataArray.map((tab)=>(
                        ...
                        ${currentTab === tab.label ? 'bg-white font-medium text-black'
            ...
            <div className="flex flex-wrap gap-6 mt-6">
                {dataArray.find((item)=>item.label === currentTab).value.map((user)=>(
                    <div key={user._id} className='w-full max-w-88 flex gap-5 p-6 bg-white shadow rounded-md'>
                        <img src={user.profile_picture} alt="PP" 
                            ...
                            <div className="flex max-sm:flex-col gap-2 mt-4">
                                {
                                    ...
                                    from-indigo-500 to-purple-600 hover:from-indigo-600 hover:to-indigo-700
